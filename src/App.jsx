...
const saveKey = 'local-board-alert.saved'
const postKey = 'local-board-alert.posts'
const alerts = [
  {
    "id": "local-board-alert-1",
    "title": "新着投稿 alert seed 1",
    "area": "名古屋",
    "category": "新着投稿",
    "score": 95,
    "summary": "地域掲示板の新着、売買、求人、イベント、防犯を通知し、店舗PR、掲載課金、広告へつなげる。 新着投稿の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "local-board-alert-2",
    "title": "売買 alert seed 2",
    "area": "東京",
    "category": "売買",
    "score": 92,
    "summary": "地域掲示板の新着、売買、求人、イベント、防犯を通知し、店舗PR、掲載課金、広告へつなげる。 売買の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "local-board-alert-3",
    "title": "求人 alert seed 3",
    "area": "大阪",
    "category": "求人",
    "score": 89,
    "summary": "地域掲示板の新着、売買、求人、イベント、防犯を通知し、店舗PR、掲載課金、広告へつなげる。 求人の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "local-board-alert-4",
    "title": "イベント alert seed 4",
    "area": "静岡",
    "category": "イベント",
    "score": 86,
    "summary": "地域掲示板の新着、売買、求人、イベント、防犯を通知し、店舗PR、掲載課金、広告へつなげる。 イベントの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">地域掲示板の新着投稿通知</p>
          <h1>Local Board Alert</h1>
          <p className="lead">地域掲示板の新着、売買、求人、イベント、防犯を通知し、店舗PR、掲載課金、広告へつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>localboardalert.jp / local-board-alert</span>
